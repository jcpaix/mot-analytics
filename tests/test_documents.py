...
from mot_analytics.documents import table_structure,document_sections,structured_business,business_description_text
...
def test_business_excerpts_use_business_prose_and_deduplicates_nested_headings():
    ...
    text=business_description_text(blocks)
    ...
    assert narrative in business_description_text([{'type':'heading','text':'6. 연구개발','level':1},{'type':'table','rows':[['HBM',narrative,'123']]}])
